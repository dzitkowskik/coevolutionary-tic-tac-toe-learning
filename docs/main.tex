...
\vspace*{\fill}
\normalfont
\textsc{Teoria Algorytmów i Obliczeń}\\ [20pt]
\horrule{1.5pt} \\[0.4cm] % Thin top horizontal rule
\LARGE Algorytmy wyznaczania podobieństwa grafów\\ % The assignment title
...
\input{technologia.tex}

\input{architektura.tex}

\input{algorytm_dokladny.tex}

\input{algorytm_aproksymacyjny.tex}

\input{algorytm_odl_edycyjna.tex}
